...
<div class="row">
    <div class="col-md-3">
        <div class="card">
            ...
            <div class="card-body">
                <!-- Form per i filtri -->
                <form action="{{ route('admin.products.filter') }}" method="GET" id="filterForm">
                    ...
                    <div class="form-group">
                        <label for="subcategory">{{__('messages.subcategory')}}:</label>
            ...
            <div class="btn btn-new-product">
                <a href="{{ route('admin.product.create') }}" class="btn btn-success">
                    <i class="fas fa-plus"></i> {{__('messages.new_product')}}
                </a>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                ...
                @foreach ($products as $product)
                    <div class="col-md-4 mb-4">
                        @component('components.admin_product_card',[
                            'product' => $product,
                        ])  
                        @endcomponent
                    </div>
